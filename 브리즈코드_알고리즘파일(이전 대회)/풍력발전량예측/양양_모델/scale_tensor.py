...
scalers = [scaler1, scaler2, scaler3, scaler4, scaler5, scaler6, scaler7, scaler8, scaler9, scaler10]

target_scaler = MinMaxScaler()

def train_valid_split(df, test):
    wtg_names = [f"wtg_{i}"for i in range(1, 11)]
    trains = {}
    valids = {}
    tests = {}
    scaled_X_trains = {}
    ...
    for wtg in wtg_names:
        ...
        trains[wtg] = df[wtg].loc["2024-04-01":"2025-01-01 00:00:00"]
        valids[wtg] = df[wtg].loc["2025-01-01 01:00:00":]
