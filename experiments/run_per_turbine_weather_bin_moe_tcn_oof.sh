...
STEM="per_turbine_weather_bin_moe_tcn_w72_oof_v1"

"$PYTHON" -m py_compile \
  utils/bin_moe.py \
  experiments/evaluate_per_turbine_weather_bin_moe_tcn_oof.py
...
"$PYTHON" experiments/evaluate_per_turbine_weather_bin_moe_tcn_oof.py \
  --window 72 \
...
printf '\n=== weather-bin MoE pooled summary ===\n'
