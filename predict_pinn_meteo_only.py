...
SUBMISSION_PATH = "results/submission_pinn_meteo.csv"
...
def build_meteo_weather_train_test():
    ...
    weather_train = add_meteo_block(weather_train, meteo_train, "all_meteo")
    weather_test = add_meteo_block(weather_test, meteo_test, "all_meteo")
    ...
    g3_train = blend_weather("group3_meteo_p90_mix", g3_unison_train, g3_vestas_train, 0.30)
    g3_test = blend_weather("group3_meteo_p90_mix", g3_unison_test, g3_vestas_test, 0.30)
...
def main():
    ...
    weather = build_meteo_weather_train_test()
